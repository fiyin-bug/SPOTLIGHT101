    ...
    <div className="bg-black text-white min-h-screen flex items-center justify-center py-16 lg:px-8 md:px-6 px-4">
      ...
      >
        ...
        <motion.p
          ...
          variants={itemVariants}
        >
          Spotlight concert and awards was founded 4 years ago with the vision
          of giving upcoming artistes a spot in the limelight to prove
          themselves.Asides the competition, the regular concert goers have a
          blast vibing to hits from mainstream artistes, some of who have graced
          our stage are, The Late MOBHAD, ASAKE, SEYI VIBEZ, T-CLASSIC, DJ
          CONSEQUENCE, DJ NEPTUNE, DJ DSF . Lagos get ready to rave !!!!
        </motion.p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          >
            <BouncingIcon
              icon={Music}
              className="w-16 h-16 mb-4 text-[#c5ac5a]"
            />
